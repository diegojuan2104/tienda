...
class Tienda {
    ...
    constructor(){
       ...
       this.productos = [
        ...
        new Producto('WE000','Uvas','',150,20,'https://img.freepik.com/premium-vector/isolated-dark-grape-with-green-leaf_317810-1956.jpg?w=2000'),
    ...
    agrega_producto_a_carrito(sku : string, cantidad: number){
        ...
        this.usuario.agrega_producto_a_carrito(producto[0], cantidad)
    }
}
